...
class Home extends StatelessWidget{const Home({super.key});Widget build(BuildContext c)=>Scaffold(appBar:AppBar(title:const Text('🙏 Delivery & Rider')),body:ListView(padding:const EdgeInsets.all(16),children:[
const Text('Rider Dashboard',style:TextStyle(fontSize:28,fontWeight:FontWeight.bold)),const Text('Discover • Pray • Request • Book • Purchase • Support'),const SizedBox(height:16),
